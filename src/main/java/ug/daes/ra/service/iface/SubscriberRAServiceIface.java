...
public interface SubscriberRAServiceIface {
	...
	ApiResponse compareImage(String suid , String capturedImage) throws Exception;

	ApiResponse getFeatures(String suid , String capturedImage) throws Exception;

	ApiResponse getSubscriberPhoto(String suid) throws Exception;

...
public class VisitorCompleteDetailsDto {
    ...
    private String walletProvisioning;

    private String visaType;

    private String onboardingDocument;
    ...
    public String getWalletProvisioning() {
        return walletProvisioning;
    }

    public void setWalletProvisioning(String walletProvisioning) {
    ...
    public String getOnboardingDocument() {
        return onboardingDocument;
    }

    public void setOnboardingDocument(String onboardingDocument) {
        this.onboardingDocument = onboardingDocument;
    }
    ...
    public String toString() {
        return "VisitorCompleteDetailsDto{" +
                ...
                ", videoUrl='" + videoUrl + '\'' +
                ", videoType='" + videoType + '\'' +
                ", nonResidentCardStatus='" + nonResidentCardStatus + '\'' +
                ", nonResidentId='" + nonResidentId + '\'' +
